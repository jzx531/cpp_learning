...
int main()
{
    ...
    // -------------------------
    Shader shader("src/mapping.vs", "src/steep_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("src/bricks2.jpg");
    unsigned int normalMap  = loadTexture("src/bricks2_normal.jpg");
    unsigned int heightMap  = loadTexture("src/bricks2_disp.jpg");
